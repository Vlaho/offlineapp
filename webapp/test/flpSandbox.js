		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Offline App",
									"targetURL": "#testofflineapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"testofflineapp-display": {
								"semanticObject": "testofflineapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=test.offlineapp",
									"url": sap.ui.require.toUrl("test/offlineapp")
								}
							}
						}
					}
